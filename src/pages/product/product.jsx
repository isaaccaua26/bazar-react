      ...
      <div className='max-w-screen-xl mx-auto my-10 flex gap-10'>
        <div className='w-2/5 relative'>
          ...
          <div className='absolute top-2 right-2'>
            {details.isNew && (
              <p className='bg-black text-white px-8 py-1'>venda</p>
          )}
          </div>
        </div>
        <div className='w-3/5 flex flex-col justify-center gap-12'>
            ...
            <div className='flex align-center gap-3 flex-start'>
              ...
              <p className='text-sm mt-1 text-gray-500'>({details.rating} Avaliações de Clientes)</p>
            </div>
              ...
              <div className='flex gap-4'>
                ...
                })) && toast.success(`${details.title} is added`)}  className='bg-black text-white py-3 px-6 active:bg-gray-800'>add ao carrinho</button>
              </div>
